    ...
    <div class="relative flex items-center justify-center min-h-screen px-4">
        <div class="bg-white dark:bg-[#0a0a0f] rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all">
            ...
            <div class="p-6">
                ...
                <form id="register-form" method="POST" action="<?php echo e(route('register')); ?>" class="hidden">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
...
const recaptchaEnabled = <?php echo e(config('services.recaptcha.enabled') ? 'true' : 'false'); ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\AniMex\resources\views/layouts/partials/auth-modals.blade.php ENDPATH**/ ?>