...
<script>
    ...
    <?php if(session('admin_login_error')): ?>
        (function(){
            const modal = document.getElementById('admin-auth-modal');
            ...
            const errorEl = document.getElementById('admin-login-error');
            if (errorEl) {
                errorEl.textContent = <?php echo json_encode(session('admin_login_error'), 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\AniMex\resources\views/layouts/partials/admin-auth-modals.blade.php ENDPATH**/ ?>