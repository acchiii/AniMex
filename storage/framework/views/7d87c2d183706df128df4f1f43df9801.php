...
<a href="<?php echo e(route('admin.anime.index')); ?>" class="text-gray-400 hover:text-gray-200 text-sm transition">&larr; Back to Anime</a>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<form action="<?php echo e(route('admin.import.search')); ?>" method="GET" class="mb-6">
    <div class="flex gap-3">
        <input type="text" name="q" value="<?php echo e($query ?? ''); ?>" placeholder="Search anime..." required
        ...
        <div class="divide-y divide-gray-800">
            <?php $__currentLoopData = $parsed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-4 px-5 py-4">
                    <img src="<?php echo e($item['image']); ?>" class="w-16 h-24 rounded-lg object-cover flex-shrink-0 bg-gray-800" alt="<?php echo e($item['title']); ?>">
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium"><?php echo e($item['title_english'] ?: $item['title']); ?></p>
                        <?php if($item['title'] !== $item['title_english']): ?>
                            <p class="text-xs text-gray-500 truncate"><?php echo e($item['title']); ?></p>
                        <?php endif; ?>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($item['type']); ?> &middot; <?php echo e($item['episodes']); ?> eps &middot; Score: <?php echo e($item['score']); ?> &middot; <?php echo e($item['status']); ?></p>
                    </div>
