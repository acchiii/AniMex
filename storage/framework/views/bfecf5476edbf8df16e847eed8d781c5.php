...
<form action="<?php echo e(route('admin.anime.update', $anime)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="title" value="<?php echo e(old('title', $anime->title)); ?>" required class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="title_english" value="<?php echo e(old('title_english', $anime->title_english)); ?>" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
            </div>
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Title (Japanese)</label>
                <input type="text" name="title_japanese" value="<?php echo e(old('title_japanese', $anime->title_japanese)); ?>" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
            </div>
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Slug</label>
                <input type="text" name="slug" value="<?php echo e(old('slug', $anime->slug)); ?>" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
            </div>
        </div>
        <div>
            <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Synopsis</label>
            <textarea name="synopsis" rows="4" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600"><?php echo e(old('synopsis', $anime->synopsis)); ?></textarea>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 space-y-4">
        ...
        <?php if($anime->cover_image): ?>
            <div class="flex items-center gap-4">
                <img src="<?php echo e(str_starts_with($anime->cover_image, 'http') ? $anime->cover_image : asset('storage/' . $anime->cover_image)); ?>" class="w-20 h-28 rounded-lg object-cover">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Current cover image</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 break-all"><?php echo e($anime->cover_image); ?></p>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Cover Image <span class="text-gray-500 dark:text-gray-400">(upload to replace)</span></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Banner Image <span class="text-gray-500 dark:text-gray-400">(upload to replace)</span></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="url" name="trailer_url" value="<?php echo e(old('trailer_url', $anime->trailer_url)); ?>" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 space-y-4">
            ...
            <div>
                ...
                <select name="type" required class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
                    ...
                    <?php $__currentLoopData = ['TV', 'Movie', 'OVA', 'ONA', 'Special', 'Music']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($t); ?>" <?php echo e(old('type', $anime->type) === $t ? 'selected' : ''); ?>><?php echo e($t); ?></option>
            ...
            <div>
                ...
                <select name="status" required class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
                    ...
                    <?php $__currentLoopData = ['ongoing', 'completed', 'upcoming', 'hiatus']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($s); ?>" <?php echo e(old('status', $anime->status) === $s ? 'selected' : ''); ?>><?php echo e(ucfirst($s)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                ...
                <select name="rating" required class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
                    ...
                    <?php $__currentLoopData = ['G', 'PG', 'PG-13', 'R', 'R+', 'Rx']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($r); ?>" <?php echo e(old('rating', $anime->rating) === $r ? 'selected' : ''); ?>><?php echo e($r); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                ...
                <select name="season" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
                    ...
                    <?php $__currentLoopData = ['Winter', 'Spring', 'Summer', 'Fall']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($s); ?>" <?php echo e(old('season', $anime->season) === $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Year</label>
                <input type="number" name="year" value="<?php echo e(old('year', $anime->year)); ?>" min="1900" max="2099" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
            </div>
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Episodes Count</label>
                <input type="number" name="episodes_count" value="<?php echo e(old('episodes_count', $anime->episodes_count)); ?>" min="0" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
            </div>
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Episode Duration (min)</label>
                <input type="number" name="episode_duration" value="<?php echo e(old('episode_duration', $anime->episode_duration)); ?>" min="0" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
            </div>
            <div>
                <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Score</label>
                <input type="number" name="score" value="<?php echo e(old('score', $anime->score)); ?>" step="0.01" min="0" max="10" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
            </div>
            <div>
                ...
                <select name="studio_id" class="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600">
                    ...
                    <?php $__currentLoopData = $studios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($studio->id); ?>" <?php echo e(old('studio_id', $anime->studio_id) == $studio->id ? 'selected' : ''); ?>><?php echo e($studio->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 pt-2">
            <?php $__currentLoopData = [
                ['name'=>'is_featured','label'=>'Featured','value'=>$anime->is_featured],
                ['name'=>'is_trending','label'=>'Trending','value'=>$anime->is_trending],
                ['name'=>'is_subbed','label'=>'Subbed','value'=>$anime->is_subbed],
                ['name'=>'is_dubbed','label'=>'Dubbed','value'=>$anime->is_dubbed],
                ['name'=>'is_premium_only','label'=>'Premium','value'=>$anime->is_premium_only],
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="<?php echo e($opt['name']); ?>" value="1" <?php echo e(old($opt['name'], $opt['value']) ? 'checked' : ''); ?> class="rounded bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-purple-600 focus:ring-purple-600">
        ...
        <div class="flex flex-wrap gap-2">
            <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="flex items-center gap-2 cursor-pointer px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-750">
                    <input type="checkbox" name="genres[]" value="<?php echo e($genre->id); ?>" <?php echo e(in_array($genre->id, old('genres', $anime->genres->pluck('id')->toArray())) ? 'checked' : ''); ?> class="rounded bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-purple-600 focus:ring-purple-600">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AniMex\resources\views/admin/anime/edit.blade.php ENDPATH**/ ?>